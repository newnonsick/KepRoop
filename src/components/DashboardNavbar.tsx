        ...
        <header className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-xl border-b border-slate-100">
            <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <Link href="/dashboard" className="flex items-center gap-2 group">
                    <div className="w-9 h-9 relative overflow-hidden rounded-1xl shadow-xl shadow-blue-500/10 border border-white">
                        <img src="/logo.png" alt="KepRoop Logo" className="w-full h-full object-cover" />
                    </div>
                    <span className="text-xl font-bold text-slate-800 group-hover:text-blue-500 transition-colors">KepRoop</span>
                </Link>
                ...
                {loading ? (
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <button className="flex items-center gap-2 p-1.5 pr-3 rounded-full hover:bg-slate-50 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2">
                        ...
                        <DropdownMenuContent align="end" className="bg-white w-56 rounded-xl shadow-lg shadow-slate-200/50 border-slate-100">
                            ...
                            <DropdownMenuItem
                                ...
                                disabled={loggingOut}
                                className="text-red-600 focus:text-red-600 focus:bg-red-50 rounded-lg mx-1 cursor-pointer"
                            >
